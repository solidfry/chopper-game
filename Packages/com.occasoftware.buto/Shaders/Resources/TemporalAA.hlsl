...
float random(float2 seed, float2 dotDir = float2(12.9898, 78.233))
{
...
void TAA(Texture2D HistoricData, Texture2D NewFrameData, float2 UV, float BlendFactor, float2 MotionVector, float Depth, out float3 Color, out float Alpha)
{
